...
- Віктор Свертока Team Lead - розробка та оформлення секції ("Customer Reviews")
...
- Евгеній Батанов - Web-developer - розробка та оформлення секції ("Аdvantages")
- Олександр Пуговський Web-developer - розробка та оформлення секції ("Gallery")
